...
### Notes:
* This is a list of queries I have thrown together to help work on conditional access policies.  The idea is to find the users that could be impacted by a particular policy example is 
...
* My Conditional Access Policy Wiki has a list of conditional access policies I recommend.
* 

...
.Description
THis will export azure security alerts
https://docs.microsoft.com/en-us/graph/api/resources/alert?view=graph-rest-beta
...
Connect-MgGraph -Scopes "Policy.Read.All","Reports.Read.All","AuditLog.Read.All","Directory.Read.All","Directory.Read.All","User.Read.All","AuditLog.Read.All","IdentityRiskyUser.Read.All","IdentityRiskEvent.Read.All","SecurityEvents.Read.All"
cd $resultslocation
...
getSecurityAlerts | export-csv .\azure_security_Alerts.csv -notypeinformation
